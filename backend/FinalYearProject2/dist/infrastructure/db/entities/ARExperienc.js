...
const arExperienceSchema = new mongoose_1.default.Schema({
    destinationId: {
...
const ARExperience = mongoose_1.default.model("ARExperience", arExperienceSchema);
module.exports = ARExperience;
//# sourceMappingURL=ARExperienc.js.map